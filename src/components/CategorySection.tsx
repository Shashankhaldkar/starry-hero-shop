  ...
  return (
    <section className="py-16 bg-starry-darkPurple">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-2 text-black">Shop by Category</h2>
        <p className="text-black text-center mb-10">Find the perfect t-shirt style for your collection</p>
